...
function LibTutorial_BriefHud:Initialize(parent)    
	...
	local function UpdateDescription()
		local tutorialId = self:GetCurrentlyDisplayedTutorialIndex()
		if tutorialId then
			local _, description = GetTutorialInfo(tutorialId) --Grab the Gamepad/Keyboard binding
...
function LibTutorial_BriefHud:SetTutorialSeen(tutorialId)
	--Overridden
end

function LibTutorial_BriefHud:DisplayTutorial(tutorialId, title, desc)
	...
	self.displayedTutorialIsActionRequired = false --IsTutorialActionRequired(tutorialId)
...
function LibTutorial_BriefHud:OnDisplayTutorial(tutorialId, priority, title, desc)
...
function LibTutorial_BriefHud:RemoveTutorial(tutorialId)
