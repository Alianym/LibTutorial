...
function LibTutorial_PointerBox:DisplayTutorial(tutorialIndex, title, desc)
...
function LibTutorial_PointerBox:OnDisplayTutorial(tutorialIndex, priority, title, desc)
